...
export function generateButtons() {
  const url = "https://thoughtandfunction.com?ref=tpl-monorepo-v3";
  return [
    {
...
export function generateGlobalSettingsData(logoImageId?: string) {
  return {
    _id: "settings",
    _type: "settings",
    contactEmail: "hi@thoughtandfunction.com",
    label: "Settings",
    logo: logoImageId
      ? {
          _type: "image",
    ...
    siteDescription:
      "Powered by Next.js and Sanity, crafted in a seamless monorepo architecture.",
    siteTitle: "Template Next Sanity",
    socialLinks: {
      linkedin: "https://uk.linkedin.com/company/thoughtandfunction",
      twitter: "",
      youtube: "",
    },
  };
